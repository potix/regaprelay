...
func main() {
	...
	// setup gamepad
        ...
        newGamepad, err := gamepad.NewGamepad(conf.Gamepad.Model, conf.Gamepad.MacAddr, conf.Gamepad.SpiMemory60, conf.Gamepad.SpiMemory80, conf.Gamepad.ConfigsHome, conf.Gamepad.Udc, gVerboseOpt)
	if err != nil {
